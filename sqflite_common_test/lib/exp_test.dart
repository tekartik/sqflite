...
/// Experimental tests.
void run(SqfliteTestContext context, {bool noMultipleStatement = false}) {
...
''';
    ...
    group('fts', () {
      test('fts3', () async {
        ...
        var path = await context.initDeleteDb('exp_fts3.db');
      ...
      test('fts4', () async {
        ...
        var path = await context.initDeleteDb('exp_fts4.db');
      ...
      test('fts5', () async {
        ...
        var path = await context.initDeleteDb('exp_fts5.db');
